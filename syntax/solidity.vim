...
syn region  yulBody              contained start='{' end='}' fold contains=yulAssemblyOp,yulControlFlow,solNumber,yulVarDeclaration,solLineComment,solComment skipwhite skipempty
