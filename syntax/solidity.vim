...
syn region  yulBody              contained start='{' end='}' fold contains=yulAssemblyOp,yulControlFlow,solNumber,yulVarDeclaration,solLineComment,solComment,yulBody skipwhite skipempty
...
syn keyword yulControlFlow       contained case default switch for break continue if function
